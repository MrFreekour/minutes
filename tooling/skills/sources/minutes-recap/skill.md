...
metadata:
  ...
  short_description: Generate a daily digest of today's policy-authorized meetings and voice memos.
  default_prompt: Use Minutes Recap for this task.
  site_category: Capture
  site_example: /minutes-recap
  site_best_for: Get a same-day digest across policy-authorized meetings and voice memos.
assets:
  scripts: []
  templates:
