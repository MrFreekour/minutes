...
triggers:
  ...
  - relationship graph
  - people across my meetings
  - show me everyone who mentioned
  - commitments by person
  - profile this person
  - research this topic across meetings
user_invocable: true
metadata:
  display_name: Minutes Graph
  short_description: Bounded person profiles and topic research; graph rankings and commitments are temporarily unavailable.
  default_prompt: Use Minutes Graph for this task.
  site_category: Intelligence
  site_example: /minutes-graph profile Alex from my normal meeting history
  site_best_for: Build a bounded person profile or research a topic; report graph-only requests unavailable with roadmap issue 513.
assets:
  scripts: []
  templates: []
  references: []
