...
metadata:
  ...
  short_description: Bounded policy-safe relationship intelligence from owned meeting history.
  ...
  site_best_for: Rank relationships, inspect commitments, confirm aliases, build a person profile, or research a topic.
assets:
  scripts: []
  templates: []
  references: []
